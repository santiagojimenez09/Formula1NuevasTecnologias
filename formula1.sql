...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-10-2021 a las 01:43:28
...
CREATE TABLE `escuderias` (
  ...
  `escuderias` varchar(50) NOT NULL,
...
--
ALTER TABLE `pilotos`
  ADD CONSTRAINT `fk_ecuderia` FOREIGN KEY (`escuderia`) REFERENCES `escuderias` (`id`);
COMMIT;
